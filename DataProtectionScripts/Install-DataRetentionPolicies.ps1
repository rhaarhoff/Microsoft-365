<# 
.SYNOPSIS
    Use this script to deploy data retention policies for OneDrive and SharePoint locations as described in the Data Protection Starter Kit.
...
Write-Host
$Answer = Read-Host "Do you want to deploy the User retention policy for OneDrive data? Type Y or N and press Enter"

if ($Answer -eq "y") {
Write-Host
$Years = Read-Host "Retain OneDrive data for how many years? Enter a value between 1 and 10 and press Enter"
$Duration = 365*$Years
...
if ($AskAction -eq "1") {
    ...
    New-RetentionCompliancePolicy -Name "User data retention policy" -OneDriveLocation All -Enabled $Enabled
    ...
    New-RetentionCompliancePolicy -Name "User data deletion policy" -OneDriveLocation All -Enabled $Enabled
...
Write-Host
$Answer = Read-Host "Do you want to deploy the Company data retention policy? Type Y or N and press Enter"
